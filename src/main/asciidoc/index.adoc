...
=== BUY BOOK VALIDATION IF BOOK ISBN IS MISSING
include::{snippets}/test-buy-book_-missing-i-s-b-n/auto-section.adoc[]
...
=== BUY BOOK VALIDATION IF CUSTOMER EMAIL IS MISSING
include::{snippets}/test-buy-book_missing-customer-email/auto-section.adoc[]


=== BUY BOOK VALIDATION IF CUSTOMER EMAIL IS INVALID
include::{snippets}/test-buy-book_invalid-customer-email/auto-section.adoc[]
